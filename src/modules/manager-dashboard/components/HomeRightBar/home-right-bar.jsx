...
export default function HomeRightBar() {
  const [view, setView] = React.useState('top'); // 'top' | 'bottom'
  ...
  return (
    <div className={styles.mainHomeRightBar}>
      ...
      <div className={styles.toggleRow}>
        <button type='button' className='btn-contained' onClick={toggleView} disabled={isSwitching}>
          {view === 'top' ? 'Show Bottom' : 'Show Top'}
        </button>
      </div>
      ...
      {/* TOP SECTION */}
      <section
        className={`${styles.section} ${view === 'top' ? styles.sectionActive : styles.sectionHidden}`}
        aria-hidden={view !== 'top'}>
        {/* first 3 line-charts */}
      ...
      {/* BOTTOM SECTION */}
      <section
        className={`${styles.section} ${view === 'bottom' ? styles.sectionActive : styles.sectionHidden}`}
        aria-hidden={view !== 'bottom'}>
